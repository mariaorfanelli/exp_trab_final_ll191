...
function inicio_testeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of inicio_testeComponents)
...
function adult_englishRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of adult_englishComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function chi_frenchRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of chi_frenchComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function adult_germanRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of adult_germanComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function chi_brazilianRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of chi_brazilianComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function adult_frenchRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of adult_frenchComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function chi_englishRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of chi_englishComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function adult_brazilian_MRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of adult_brazilian_MComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function chi_germanRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of chi_germanComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function adult_brazilian_FRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of adult_brazilian_FComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function obrigadaRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of obrigadaComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
